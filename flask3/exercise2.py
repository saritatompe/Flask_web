...
from wtforms import (StringField,SubmitField,BooleanField,DateField,RadioField,SelectField,TextField,TextAreaField)
...
class InfoForm(FlaskForm):
    ...
    degree = RadioField('Please choose you degree :',choices=[('level_one','Undergrad'),('level_two','Graduate')])
